  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        const mailtoEmail = "contactus@ionecenter.com"
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Your ticket will be sent to <a href="mailto:contactus@ionecenter.com" className="text-primary underline">contactus@ionecenter.com</a>
            </p>
