...
import { createOfflineInvoice, updateOfflineInvoice, searchSellerProducts, getSellerBankInfo, searchBuyers, getNextSellerInvoiceNumber, searchBuyerByCode } from "@/lib/actions/invoices"
...
interface EditData {
  ...
  discount: number
  amount_paid: number
  items: { item_code: string | null; product_name: string | null; description: string | null; unit_price: number; quantity: number }[]
}
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex flex-wrap items-center gap-3 print:hidden">
        <Button onClick={handleSave} disabled={saving || (!isEditMode && !!savedInvoiceId)}>
          ...
          {!isEditMode && savedInvoiceId ? t("saved") : isEditMode ? t("updateInvoice") : t("saveInvoice")}
        </Button>
        <Button
          variant="outline"
