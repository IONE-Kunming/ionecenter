-- Development Seed Data for IONE AlumaTech

-- Test Users
INSERT INTO users (id, clerk_id, email, display_name, role, company, phone_number, preferred_language, city, country) VALUES
  ('00000000-0000-0000-0000-000000000001', 'admin_clerk_id', 'admin@ione.live', 'Admin User', 'admin', 'IONE AlumaTech', '+86-123-4567-8901', 'en', 'Kunming', 'China'),
